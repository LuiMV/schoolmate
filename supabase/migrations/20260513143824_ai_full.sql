...
-- ============================================================
-- 9. CHAT SESSIONS (AI assistant conversation history)
-- ============================================================
...
-- ============================================================
-- 10. CHAT MESSAGES (individual messages in a session)
-- ============================================================
...
-- ============================================================
-- 11. RESOURCE ANALYSIS (AI-generated content per resource)
-- ============================================================
...
create policy "Teachers can manage analysis"
  on resource_analysis for all
  using (
    exists (
      select 1 from resources
      where resources.id = resource_analysis.resource_id
        and resources.teacher_id = auth.uid()
    )
  );

create policy "Students can view analysis"
  on resource_analysis for select
  using (
    exists (
      select 1 from resources
